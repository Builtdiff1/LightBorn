...
namespace PinePie.PieTabs
{
    ...
    public static class NavigatorLoader
    {
        ...
        static void RunOnceOnLoad()
        {
            ...
            if (!Directory.Exists("Assets/PinePie/PieTabs"))
                return;
    ...
    public static partial class Navigator
    {
        ...
        public static void Setup()
        {
            ...
            UI.mainUI.styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/PinePie/PieTabs/Core/UI/PieDeskStyling.uss"));
